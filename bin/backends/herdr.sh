...
# An alternation of the literal glyphs, not a bracket expression: under a
# non-UTF-8 locale grep matches a bracket expression byte-wise, and the box
# corners ╭ ╰ share these glyphs' 0xe2 lead byte, which misread a bordered
# box's corner rows as a bare composer.
